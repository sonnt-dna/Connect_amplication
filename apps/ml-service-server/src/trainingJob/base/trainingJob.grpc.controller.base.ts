...
export class TrainingJobGrpcControllerBase {
  ...
  @GrpcMethod("TrainingJobService", "trainingJobs")
  ...
  @GrpcMethod("TrainingJobService", "trainingJob")
  async trainingJob(
  ...
  @swagger.ApiOkResponse({ type: TrainingJob })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("TrainingJobService", "updateTrainingJob")
  ...
  @swagger.ApiOkResponse({ type: TrainingJob })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("TrainingJobService", "deleteTrainingJob")
